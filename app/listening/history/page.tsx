...
import { Headphones, ChevronRight, Clock, Filter, AlertCircle, TrendingUp } from "lucide-react";
...
export default function ListeningHistoryPage() {
  const [attempts, setAttempts] = useState<ListeningAttemptRecord[]>([]);
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex items-start justify-between">
        <div>
          <h1 className="text-3xl font-bold" style={{ color: "var(--foreground)" }}>Listening History</h1>
          <p className="mt-1" style={{ color: "var(--muted)" }}>Review your past listening attempts and track your progress.</p>
        </div>
        <Link
          href="/listening"
        ...
        >
          <Headphones size={15} /> New Attempt
        </Link>
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        {(["All", "IELTS", "CELPIP"] as const).map((f) => (
          <button
            ...
            style={{
              background: filter === f ? "linear-gradient(135deg, #6366f1, #3b82f6)" : "var(--card)",
      ...
      <div className="space-y-3">
        ...
        {!loading && !error && filtered.length === 0 && (
          <div
            ...
            style={{ background: "var(--card)", border: "1px solid var(--card-border)" }}
          >
            <p style={{ color: "var(--muted)" }}>No listening attempts yet. Complete a session to see it here!</p>
          </div>
        )}
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center gap-4 text-xs flex-wrap" style={{ color: "var(--muted)" }}>
                ...
                <span>·</span>
                <span className="truncate max-w-[180px]">{attempt.section_title}</span>
            ...
            <div className="flex items-center gap-3 shrink-0">
              ...
              <Link
                href={`/listening/feedback/${attempt.attempt_id}`}
